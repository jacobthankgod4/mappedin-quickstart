...
const icons = {
  ...
  walk: '<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><circle cx="13.5" cy="3.5" r="1.5"/><path d="M6 16l1.5-5L10 9l1 3 3-1.5L16 14l-2.5 7h-2l-1.5-4.5L8 18.5z"/><path d="M10 9L8.5 6h3l1.5 3z"/></svg>',
